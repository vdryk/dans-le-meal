package com.ach.danslemeal.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ach.danslemeal.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ach.danslemeal.repository.UserRepository.USERS_BY_EMAIL_CACHE);
